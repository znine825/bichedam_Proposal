            ...
            <div className = 'body'>
                ...
                <motion.div 
                    ...
                    <Subtitle 
                        ...
                        text2 = '비효율적인 디자인'/>
                    <Margin distance_w = '100%' distance_h = '30px'/>
                    <Text text = '동일한 카드형 컴포넌트가 웹사이트 전반에 걸쳐 반복적으로 사용되고 있습니다. 해당 요소는 마우스 오버 시 테두리 색상이 변경되어 상호작용 가능한 버튼처럼 인식되지만, 실제로는 클릭 기능이 제공되지 않아 사용자에게 혼란을 줄 수 있습니다.////특히 판매처 카드 부분에서 이러한 혼란이 가장 두드러지게 나타납니다.'/>
                    <Margin distance_w = '100%' distance_h = '30px'/>
                    ...
                    <Title 
                        title = '해결방안'
                        count = '02'
                        text = '기존 비체담 웹사이트는 페이지 이동 시마다 전체 페이지를 새로 불러오는 구조로 인해 로딩 속도가 느리고, 다양한 기기 환경에서 레이아웃이 맞지 않는 문제가 발생하고 있습니다.'/>
                    ...
                    <Images3 image1 = 'Overview/211.png' image2 = 'Overview/212.png' image3 = 'Overview/213.png'
                             ...
                             text3 = '사이드 맵이 잘리는 모습'/>
                    <Margin distance_w = '100%' distance_h = '30px'/>
                    <Text text = 'React 프레임워크는 컴포넌트 단위로 UI를 구성하기 때문에 반응형 웹사이트 개발을 체계적이고 효율적으로 구현할 수 있습니다.////또한 React는 Virtual DOM 방식을 사용해 변경된 부분만 선택적으로 다시 렌더링하기 때문에, 페이지 전체를 새로 불러오지 않아도 되어 초기 로딩 시간을 크게 단축할 수 있습니다.//지금 이 페이지 역시 같은 컴포넌트를 반복 활용하여 단기간에 제작하였습니다.'></Text>
